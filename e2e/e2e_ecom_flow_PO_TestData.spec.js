...
test('e2e_ecom_flow_PO', async ({ browser }) => {
    ...
    await expect(page.locator('div.address').first().locator("p").first()).toContainText(username)
    ...
    await expect(page.locator('div.address').last().locator("p").first()).toContainText(username)
